    ...
    class ContractPlanBuilder
      ...
      def build_contract_plan(contract:, start_date:, end_date:)
        ...
        while start_date <= end_date
          ...
          build_slots(contract_plan: contract_plan, date: start_date, duration: contract_plan.slot_duration, start_at: day_option[:start_at],
      ...
      def build_slots(contract_plan:, date:, duration:, start_at:, end_at:)
        ...
        while position_start < position_end
          TimeSlot.create!(start_at: position_start, duration: duration, contract_id: contract_plan.contract_id,
